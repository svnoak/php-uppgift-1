...
<div class='bubble speechbubble-house' id='user'>
    ...
    <div class='content'>
        <div class='paragraphs'>
            ...
            <a class='dialog-option' href='?dialog=2'>No, I've got to pick up a dog of mine first.</a>
        </div>
    </div>
...
<div class='scroll scroll-add'>
    ...
    <form action='add.php' method='post' id='add-form' class='content'>
...
$home = [$welcomeMessage, $dialog_1, $dialog_2, $dialog_3, $dialog_4, $dialog_5, $dialog_6, $signin_1, $signin_2];
